...
import { ProductCategoryRow } from "../lib/product-categories.types";
import {
...
const baseColumns: Column<ProductCategoryRow>[] = [
  {
    key: "name",
    header: "Categoría",
...
export function ProductCategoriesTable({
  ...
  isLoading: boolean;
  onEditAction: (category: ProductCategoryRow) => void;
  onDeleteAction: (category: ProductCategoryRow) => void;
  ...
  function handleToggle(category: ProductCategoryRow) {
  ...
  function handleRestore(category: ProductCategoryRow) {
  ...
  const columns: Column<ProductCategoryRow>[] = [
    ...baseColumns,
    {
      key: "is_active",
      header: "Activa",
